...
bash -c "source ../../venv/bin/activate && source ../install/setup.bash && ros2 r#un servo lut_control"
#bash -c "source ../../venv/bin/activate && source ../install/setup.bash && ros2 run pharma_delivery ver_04_2025_bag"